...
As we have seen with implementation \ref{impl:qshaskell} (\nameref{impl:qshaskell}), these assumptions do not hold in a functional setting, where it is neither possible to perform \emph{in-place-updates}, nor to access an arbitrary element at constant time.
